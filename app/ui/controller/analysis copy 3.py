...
def analysis_genes_view(request, project_pk):
    ...
    return render(request, 'ui_new/user/analysis/gene_analysis_overview.html', dict(projects = projects, project_pk = project_pk, geneanalyses = geneanalyses))
...
def analysis_genes_add_remove(request, sample_pk):
    ...
    custom_edit_page = request.GET.get('edit')
