...
def patients_view_user(request, project_pk):
    ...
    return render(request, 'ui_new/user/patients/patients.html', dict(project_pk = project_pk, patientdpts = json.dumps(patientdpts), projects = projects, projectids = projectids, formpatient = formpatient, formprojectid = formprojectid, current_page = 'patients', current_line = "patients"))
